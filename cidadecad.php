...
if(isset($_POST['btAlterar'])){
    if($objFcn->dao->queryUpdate($_POST) == 'ok'){
...
if(isset($_GET['acao'])){
    switch($_GET['acao']){
        case 'edit': $func = $objFcn->dao->querySeleciona($_GET['func']); break;
        case 'delet':
          if($objFcn->dao->queryDelete($_GET['func']) == 'ok'){
                header('location: /teste');
            }else{
...
<div id="lista">
    ...
    <div class="funcionario">
        ...
        <div class="sigla"><?=$objFcs->tratarCaracter($rst['estado_id'], 2)?></div>
